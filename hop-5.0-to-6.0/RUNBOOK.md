...
per hop upgrade"](../BACKUP_RESTORE.md#pola-umum-rollback-per-hop-upgrade). Untuk hop ini: titik baginya adalah **tahap 5** — sebelum itu
...
lintas-hop"](../ROADMAP.md#pelajaran-operasional-lintas-hop-bukan-cuma-build-from-source) — jalankan lebih
