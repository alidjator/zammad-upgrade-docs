...
**Estimasi total waktu eksekusi:** ~5,2 jam (build 32m17s + migrasi 1m33s + reindex ES
~4,6 jam, angka terkoreksi — lihat [../DOWNTIME_ESTIMATE.md](../DOWNTIME_ESTIMATE.md)).
Durasi per tahap tercantum inline di tiap langkah di bawah; rincian lengkap di
